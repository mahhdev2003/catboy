    ...
    719: function (e, t, s) {
      ...
      function g({
        ...
        if (
          ...
          i.includes("children") && t && m && p.virtual.enabled
      ...
      const C = (0, i.forwardRef)(function (e, t) {
        ...
        const W = () => {
          if (
            ...
            B.loop && (_.current.loopedSlides = u(V, B)),
        ...
        return (
          ...
          v(() => {
            ...
            })(j, I.current, V, z.current, (e) => e.key);
            return (
              (I.current = j),
              (z.current = V),
              e.length &&
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                B.virtual
                  ...
                  ? V.map((e) => i.cloneElement(e, { swiper: _.current }))
                  : (function (e, t, s) {
                      const n = t.map((t, s) =>
                        i.cloneElement(t, {
                          swiper: e,
      ...
      var L = {
        ...
        updateSlides: function () {
          ...
          for (let S = 0; S < p; S += 1) {
            ...
            const n = c.eq(S);
            if (
              (x && e.grid.updateSlide(S, n, p, t), "none" !== n.css("display"))
            ) {
        ...
        le({
          ...
          setTranslate: () => {
            const { width: t, height: s, slides: i, slidesSizesGrid: n } = e,
              ...
              c = r.depth;
            for (let e = 0, p = i.length; e < p; e += 1) {
              const t = i.eq(e),
                s = n[e],
              ...
              if (
                ...
                0 === e.length && (e = ce(r, t, a ? "left" : "top")),
                  0 === s.length && (s = ce(r, t, a ? "right" : "bottom")),

    ...
    7339: function (e, t, r) {
                    ...
                    (N.isFallback ||
                      (N.nextExport &&
                        (_.isDynamicRoute(h.pathname) ||
                          location.search ||
                          G)) ||
                      (N.props && N.props.__N_SSG && (location.search || G))) &&
                    h
                      .replace(
                        h.pathname +
                          "?" +
      ...
      function ae(e) {
        ...
        return v.default.createElement(
          ...
          {
            fn: function (e) {
              return Q({ App: B, err: e }).catch(function (e) {
      ...
      var ie,
        ue = function (e) {
          return function (t) {
            var r = d({}, t, { Component: U, err: N.err, router: h });
          ...
          return (
            a(e, [
              ...
              },
              {
                ...
                value: function () {
                  return (
                    (window.__MIDDLEWARE_MANIFEST = { location: ".*" }),
                    ...
                    if (o) {
                      ...
                      var d = k.parsePath(e),
                        v = N.formatNextPathnameInfo(
                          s(
                            {},
                            T.getNextPathnameInfo(d.pathname, {
                              nextConfig: n,
                              parseData: !0,
                            }),
                            {
                      ...
                      if (m.startsWith("/")) {
                        var y = k.parsePath(m),
                          _ = N.formatNextPathnameInfo(
                            s(
                              {},
                              T.getNextPathnameInfo(y.pathname, {
                                nextConfig: n,
                                parseData: !0,
                              }),
                              {
